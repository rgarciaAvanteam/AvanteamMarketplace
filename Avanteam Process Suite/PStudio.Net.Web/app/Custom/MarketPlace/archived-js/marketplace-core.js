 ...
 */
window.ConfigManager = window.Marketplace.defineModule('ConfigManager', function() {
    // Valeurs par défaut
    const defaults = {
        apiUrl: '',
        apiKey: '',
 ...
 */
window.initVersionsDisplay = function() {
 ...
 */
window.refreshComponentLists = function() {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof window.MarketplaceAuth !== 'undefined' && typeof window.MarketplaceAuth.init === 'function') {
        window.MarketplaceAuth.init(window.ConfigManager.getApiUrl());
    }
