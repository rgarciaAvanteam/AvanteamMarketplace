...
const MarketplaceAuth = (function() {
    ...
    const config = {
        ...
        callbackUrl: window.location.origin + "/Custom/MarketPlace/auth-callback.html"
    };
    ...
    function login() {
        ...
        const authUrl = `${config.apiUrl}/api/auth/login?redirectUri=${encodeURIComponent(config.callbackUrl)}`;
