...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Charger les scripts du Marketplace -->
        <script src="js/marketplace/marketplace-auth.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-core.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-components.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-stream.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-install.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-uninstall.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-filters.js" type="text/javascript"></script>
        <script src="js/marketplace/marketplace-ui.js" type="text/javascript"></script>
