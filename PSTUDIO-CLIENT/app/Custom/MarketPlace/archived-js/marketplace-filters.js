...
window.MarketplaceFilters = (function() {
    // État des filtres
    let state = {
        activeFilters: {
            categories: [],
    ...
    function applyFilters() {
        if (typeof MarketplaceComponents === 'undefined') {
        ...
        if (!hasActiveFilters) {
            MarketplaceComponents.resetComponentsFilter();
            updateComponentCount(MarketplaceComponents.getVisibleComponentsCount());
            return;
        }
        ...
        MarketplaceComponents.filterComponents(filterFunc);
