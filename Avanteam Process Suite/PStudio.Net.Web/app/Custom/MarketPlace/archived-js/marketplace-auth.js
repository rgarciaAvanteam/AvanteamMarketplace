...
window.MarketplaceAuth = window.Marketplace.defineModule('MarketplaceAuth', function() {
                ...
                validateToken(state.token).then(result => {
                    if (result.isValid) {
                        ...
                        if (typeof window.ConfigManager !== 'undefined') {
                            ...
                            console.log("Configuration réinitialisée après authentification, platformVersion =", window.ConfigManager.getPlatformVersion());
                        }
    ...
    function updateUI() {
        ...
        if (versionDisplay) {
            ...
            if (!currentVersion || currentVersion === "") {
                ...
                const configVersion = window.ConfigManager.getPlatformVersion();
                if (configVersion) {
