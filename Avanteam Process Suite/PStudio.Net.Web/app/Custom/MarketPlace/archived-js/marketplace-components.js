 ...
 */
window.MarketplaceComponents = (function() {
 ...
 * @param {Array} components - Liste des composants à afficher
 */
window.renderComponents = function(tabName, components) {
    // Utiliser le module MarketplaceComponents pour initialiser les composants
    window.MarketplaceComponents.initComponents(tabName, components);
}
 ...
 * @param {number} componentId - ID du composant
 */
window.logComponentData = function(componentId) {
 ...
 */
window.checkAuthAndUninstall = function(componentId) {
 ...
 * @param {number} componentId - ID du composant
 */
window.showComponentReadme = function(componentId) {
